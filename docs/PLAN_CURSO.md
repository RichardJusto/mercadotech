> **Nota (Sesión 7, Fase 7.5):** este documento es el plan original del curso
> **Claude Code for Developers**, escrito antes de empezar la Sesión 2 y usado
> como guía de las 8 sesiones. Se movió acá, intacto, para dejarle su lugar al
> [`README.md`](../README.md) de la raíz, que ahora es la documentación de
> PRODUCTO (qué es MercadoTech, cómo levantarlo, cómo se despliega) — la
> distinción es la que pide la spec de la Sesión 7 (decisión 11): el plan del
> curso tiene valor histórico propio, pero un desarrollador nuevo que clona el
> repo necesita el README de producto, no el plan de 8 sesiones.
